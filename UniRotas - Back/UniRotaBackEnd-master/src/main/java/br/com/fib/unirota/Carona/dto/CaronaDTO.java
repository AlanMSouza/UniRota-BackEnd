...
public record CaronaDTO(Long id, String localOrigem, BigDecimal preco, LocalDate dataInicial,
    LocalDate dataFinal, String horarioSaida, String horarioRetorno,
    int assentos,
    UsuarioDTO usuario, boolean caronaRecorrente, CarroDTO carro,
    List<Long> listaUsuariosPendenteId,
  ...
  public CaronaDTO(Carona carona) {
    this(
        ...
        carona.getSolicitoes()
            ...
            .map(solicitacao -> solicitacao.getUsuario().getId())
